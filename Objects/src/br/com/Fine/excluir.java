...
public class excluir extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "br.com.Fine", "br.com.Fine.excluir");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "br.com.Fine", "br.com.Fine.excluir");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "br.com.Fine.excluir", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
...
if (mostCurrent._main._pers._excluir_login(mostCurrent._username.getText(),mostCurrent._senha.getText())) { 
 //BA.debugLineNum = 33;BA.debugLine="File.Delete(File.DirRootExternal&\"/Fine/Data\",user&\"saldo.txt\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Fine/Data",_user+"saldo.txt");
 //BA.debugLineNum = 34;BA.debugLine="File.Delete(File.DirRootExternal&\"/Fine/Data\",user&\"categ.txt\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Fine/Data",_user+"categ.txt");
 //BA.debugLineNum = 35;BA.debugLine="File.Delete(File.DirRootExternal&\"/Fine/Data\",user&\"transacoes.txt\")";
...
mostCurrent._username = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 12;BA.debugLine="Private Senha As EditText";
mostCurrent._senha = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 13;BA.debugLine="Private Button_Excluir As Button";
