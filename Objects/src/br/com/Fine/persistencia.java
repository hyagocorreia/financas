...
public class persistencia extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "br.com.Fine.persistencia");
            if (htSubs == null) {
                ba.loadHtSubs(this.getClass());
                htSubs = ba.htSubs;
            }
            if (ba.getClass().getName().endsWith("ShellBA")) {
			    ba.raiseEvent2(null, true, "CREATE", true, "br.com.Fine.persistencia",
                    ba);
		    }
        }
...
anywheresoftware.b4a.objects.streams.File.TextWriterWrapper _textwriter1 = null;
 //BA.debugLineNum = 338;BA.debugLine="Public Sub Atualizar_Username(uNovo As String)";
 //BA.debugLineNum = 339;BA.debugLine="If File.Exists(caminho, Logado&\"saldo.txt\") Then";
if (__c.File.Exists(_caminho,_logado()+"saldo.txt")) { 
 //BA.debugLineNum = 340;BA.debugLine="RenameFile(caminho&\"/\"&Logado&\"saldo.txt\",caminho&\"/\"&uNovo&\"saldo.txt\")";
_renamefile(_caminho+"/"+_logado()+"saldo.txt",_caminho+"/"+_unovo+"saldo.txt");
 //BA.debugLineNum = 341;BA.debugLine="File.Delete(caminho,Logado&\"saldo.txt\")";
__c.File.Delete(_caminho,_logado()+"saldo.txt");
 };
 //BA.debugLineNum = 344;BA.debugLine="If File.Exists(caminho, Logado&\"categ.txt\") Then";
if (__c.File.Exists(_caminho,_logado()+"categ.txt")) { 
 //BA.debugLineNum = 345;BA.debugLine="RenameFile(caminho&\"/\"&Logado&\"categ.txt\",caminho&\"/\"&uNovo&\"categ.txt\")";
_renamefile(_caminho+"/"+_logado()+"categ.txt",_caminho+"/"+_unovo+"categ.txt");
 //BA.debugLineNum = 346;BA.debugLine="File.Delete(caminho, Logado&\"categ.txt\")";
__c.File.Delete(_caminho,_logado()+"categ.txt");
 };
 //BA.debugLineNum = 349;BA.debugLine="If File.Exists(caminho, Logado&\"transacoes.txt\") Then";
if (__c.File.Exists(_caminho,_logado()+"transacoes.txt")) { 
 //BA.debugLineNum = 350;BA.debugLine="RenameFile(caminho&\"/\"&Logado&\"transacoes.txt\",caminho&\"/\"&uNovo&\"transacoes.txt\")";
_renamefile(_caminho+"/"+_logado()+"transacoes.txt",_caminho+"/"+_unovo+"transacoes.txt");
 //BA.debugLineNum = 351;BA.debugLine="File.Delete(caminho, Logado&\"transacoes.txt\")";
__c.File.Delete(_caminho,_logado()+"transacoes.txt");
 };
 //BA.debugLineNum = 354;BA.debugLine="If File.Exists(caminho,\"logado.txt\") Then";
if (__c.File.Exists(_caminho,"logado.txt")) { 
 //BA.debugLineNum = 355;BA.debugLine="File.Delete(caminho,\"logado.txt\")";
__c.File.Delete(_caminho,"logado.txt");
 //BA.debugLineNum = 356;BA.debugLine="Dim TextWriter1 As TextWriter";
_textwriter1 = new anywheresoftware.b4a.objects.streams.File.TextWriterWrapper();
 //BA.debugLineNum = 357;BA.debugLine="TextWriter1.Initialize(File.OpenOutput(caminho,\"logado.txt\",True))";
_textwriter1.Initialize((java.io.OutputStream)(__c.File.OpenOutput(_caminho,"logado.txt",__c.True).getObject()));
 //BA.debugLineNum = 358;BA.debugLine="TextWriter1.Write(uNovo)";
_textwriter1.Write(_unovo);
 //BA.debugLineNum = 359;BA.debugLine="TextWriter1.Close";
_textwriter1.Close();
 }else {
 //BA.debugLineNum = 361;BA.debugLine="Dim TextWriter1 As TextWriter";
_textwriter1 = new anywheresoftware.b4a.objects.streams.File.TextWriterWrapper();
 //BA.debugLineNum = 362;BA.debugLine="TextWriter1.Initialize(File.OpenOutput(caminho,\"logado.txt\",True))";
_textwriter1.Initialize((java.io.OutputStream)(__c.File.OpenOutput(_caminho,"logado.txt",__c.True).getObject()));
 //BA.debugLineNum = 363;BA.debugLine="TextWriter1.Write(uNovo)";
_textwriter1.Write(_unovo);
 //BA.debugLineNum = 364;BA.debugLine="TextWriter1.Close";
_textwriter1.Close();
 };
...
int _i = 0;
String _categ = "";
 //BA.debugLineNum = 277;BA.debugLine="Public Sub Deletar_Categoria(Categoria As String) As String";
...
if (true) return "False";
 ...
 //BA.debugLineNum = 283;BA.debugLine="Dim listaTrans As List";
_listatrans = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 284;BA.debugLine="listaTrans = GetTransacoes(Main.Pers.Logado)";
_listatrans = _gettransacoes(_main._pers._logado());
 //BA.debugLineNum = 286;BA.debugLine="For Each trans As String In listaTrans";
final anywheresoftware.b4a.BA.IterableList group251 = _listatrans;
final int groupLen251 = group251.getSize();
for (int index251 = 0;index251 < groupLen251 ;index251++){
_trans = BA.ObjectToString(group251.Get(index251));
 //BA.debugLineNum = 287;BA.debugLine="Dim str As String";
_str = "";
 //BA.debugLineNum = 288;BA.debugLine="str = trans.SubString(trans.LastIndexOf(\";\")+1)";
_str = _trans.substring((int) (_trans.lastIndexOf(";")+1));
 //BA.debugLineNum = 289;BA.debugLine="If Categoria = str Then";
if ((_categoria).equals(_str)) { 
 //BA.debugLineNum = 290;BA.debugLine="Return \"Null\"";
if (true) return "Null";
 };
 }
;
 //BA.debugLineNum = 294;BA.debugLine="TextReader1.Initialize(File.OpenInput(caminho,Logado&\"categ.txt\"))";
_textreader1.Initialize((java.io.InputStream)(__c.File.OpenInput(_caminho,_logado()+"categ.txt").getObject()));
 //BA.debugLineNum = 296;BA.debugLine="Dim Lista As List";
_lista = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 297;BA.debugLine="Lista.Initialize";
_lista.Initialize();
 //BA.debugLineNum = 298;BA.debugLine="Lista.AddAll(TextReader1.ReadList)";
_lista.AddAll(_textreader1.ReadList());
 //BA.debugLineNum = 299;BA.debugLine="TextReader1.Close";
_textreader1.Close();
 //BA.debugLineNum = 301;BA.debugLine="File.Delete(caminho,Logado&\"categ.txt\")";
__c.File.Delete(_caminho,_logado()+"categ.txt");
 //BA.debugLineNum = 303;BA.debugLine="Dim i As Int = 0";
_i = (int) (0);
 //BA.debugLineNum = 304;BA.debugLine="For Each categ As String In Lista";
final anywheresoftware.b4a.BA.IterableList group265 = _lista;
final int groupLen265 = group265.getSize();
for (int index265 = 0;index265 < groupLen265 ;index265++){
_categ = BA.ObjectToString(group265.Get(index265));
 //BA.debugLineNum = 305;BA.debugLine="Dim str As String";
_str = "";
 //BA.debugLineNum = 306;BA.debugLine="str = categ.SubString(categ.LastIndexOf(\";\")+1)";
_str = _categ.substring((int) (_categ.lastIndexOf(";")+1));
 //BA.debugLineNum = 307;BA.debugLine="If Categoria = str Then";
if ((_categoria).equals(_str)) { 
 //BA.debugLineNum = 308;BA.debugLine="Lista.RemoveAt(i)";
_lista.RemoveAt(_i);
 };
 //BA.debugLineNum = 310;BA.debugLine="i=i+1";
_i = (int) (_i+1);
 }
;
...
_textwriter1.Initialize((java.io.OutputStream)(__c.File.OpenOutput(_caminho,_logado()+"categ.txt",__c.True).getObject()));
 //BA.debugLineNum = 314;BA.debugLine="TextWriter1.WriteList(Lista)";
_textwriter1.WriteList(_lista);
 //BA.debugLineNum = 315;BA.debugLine="TextWriter1.Close";
_textwriter1.Close();
...
anywheresoftware.b4a.objects.streams.File.TextWriterWrapper _textwriter1 = null;
anywheresoftware.b4a.objects.collections.List _lista = null;
 //BA.debugLineNum = 320;BA.debugLine="Public Sub GetCategorias As List";
 //BA.debugLineNum = 321;BA.debugLine="Dim TextReader1,TextReader2 As TextReader";
_textreader1 = new anywheresoftware.b4a.objects.streams.File.TextReaderWrapper();
_textreader2 = new anywheresoftware.b4a.objects.streams.File.TextReaderWrapper();
 //BA.debugLineNum = 322;BA.debugLine="TextReader1.Initialize(File.OpenInput(File.DirAssets,\"categ.txt\"))";
_textreader1.Initialize((java.io.InputStream)(__c.File.OpenInput(__c.File.getDirAssets(),"categ.txt").getObject()));
 //BA.debugLineNum = 323;BA.debugLine="If Not(File.Exists(caminho,Logado&\"categ.txt\")) Then";
if (__c.Not(__c.File.Exists(_caminho,_logado()+"categ.txt"))) { 
 //BA.debugLineNum = 324;BA.debugLine="Dim TextWriter1 As TextWriter";
_textwriter1 = new anywheresoftware.b4a.objects.streams.File.TextWriterWrapper();
 //BA.debugLineNum = 325;BA.debugLine="TextWriter1.Initialize(File.OpenOutput(caminho,Logado&\"categ.txt\",True))";
_textwriter1.Initialize((java.io.OutputStream)(__c.File.OpenOutput(_caminho,_logado()+"categ.txt",__c.True).getObject()));
 //BA.debugLineNum = 326;BA.debugLine="TextWriter1.Close";
_textwriter1.Close();
 };
 //BA.debugLineNum = 328;BA.debugLine="TextReader2.Initialize(File.OpenInput(caminho,Logado&\"categ.txt\"))";
_textreader2.Initialize((java.io.InputStream)(__c.File.OpenInput(_caminho,_logado()+"categ.txt").getObject()));
 //BA.debugLineNum = 329;BA.debugLine="Dim Lista As List";
_lista = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 330;BA.debugLine="Lista.Initialize";
_lista.Initialize();
 //BA.debugLineNum = 331;BA.debugLine="Lista.AddAll(TextReader1.ReadList)";
_lista.AddAll(_textreader1.ReadList());
 //BA.debugLineNum = 332;BA.debugLine="Lista.AddAll(TextReader2.ReadList)";
_lista.AddAll(_textreader2.ReadList());
 //BA.debugLineNum = 333;BA.debugLine="TextReader1.Close";
_textreader1.Close();
 //BA.debugLineNum = 334;BA.debugLine="TextReader2.Close";
_textreader2.Close();
 //BA.debugLineNum = 335;BA.debugLine="Return Lista";
...
anywheresoftware.b4a.objects.collections.List _transacoes = null;
 //BA.debugLineNum = 186;BA.debugLine="Public Sub GetTransacoes(Usuario As String) As List";
 //BA.debugLineNum = 187;BA.debugLine="Dim TextReader1 As TextReader";
_textreader1 = new anywheresoftware.b4a.objects.streams.File.TextReaderWrapper();
 //BA.debugLineNum = 188;BA.debugLine="If Not(File.Exists(caminho,Logado&\"transacoes.txt\")) Then";
if (__c.Not(__c.File.Exists(_caminho,_logado()+"transacoes.txt"))) { 
 //BA.debugLineNum = 189;BA.debugLine="Dim tw As TextWriter";
_tw = new anywheresoftware.b4a.objects.streams.File.TextWriterWrapper();
 //BA.debugLineNum = 190;BA.debugLine="tw.Initialize(File.OpenOutput(caminho,Logado&\"transacoes.txt\",True))";
_tw.Initialize((java.io.OutputStream)(__c.File.OpenOutput(_caminho,_logado()+"transacoes.txt",__c.True).getObject()));
 //BA.debugLineNum = 191;BA.debugLine="tw.Close";
_tw.Close();
 };
 //BA.debugLineNum = 193;BA.debugLine="TextReader1.Initialize(File.OpenInput(caminho,Logado&\"transacoes.txt\"))";
_textreader1.Initialize((java.io.InputStream)(__c.File.OpenInput(_caminho,_logado()+"transacoes.txt").getObject()));
 //BA.debugLineNum = 194;BA.debugLine="Dim transacoes As List";
_transacoes = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 195;BA.debugLine="transacoes.Initialize";
_transacoes.Initialize();
 //BA.debugLineNum = 196;BA.debugLine="transacoes = TextReader1.ReadList";
_transacoes = _textreader1.ReadList();
 //BA.debugLineNum = 197;BA.debugLine="TextReader1.Close";
_textreader1.Close();
...
_textreader1 = new anywheresoftware.b4a.objects.streams.File.TextReaderWrapper();
 //BA.debugLineNum = 244;BA.debugLine="TextReader1.Initialize(File.OpenInput(caminho, \"Logins.txt\"))";
_textreader1.Initialize((java.io.InputStream)(__c.File.OpenInput(_caminho,"Logins.txt").getObject()));
...
innerInitialize(_ba);
 ...
 //BA.debugLineNum = 7;BA.debugLine="caminho = File.DirRootExternal&\"/Fine/Data\"";
_caminho = __c.File.getDirRootExternal()+"/Fine/Data";
...
_usuario = _textreader1.ReadLine();
 //BA.debugLineNum = 182;BA.debugLine="TextReader1.Close";
_textreader1.Close();
 //BA.debugLineNum = 183;BA.debugLine="Return usuario";
...
_linha2 = _linha1.substring((int) (0),_linha1.indexOf(";"));
 //BA.debugLineNum = 226;BA.debugLine="TextReader1.Initialize(File.OpenInput(caminho,Logado&\"transacoes.txt\"))";
_textreader1.Initialize((java.io.InputStream)(__c.File.OpenInput(_caminho,_logado()+"transacoes.txt").getObject()));
...
_textreader1.Close();
 //BA.debugLineNum = 230;BA.debugLine="File.Delete(caminho,Logado&\"transacoes.txt\")";
__c.File.Delete(_caminho,_logado()+"transacoes.txt");
 //BA.debugLineNum = 232;BA.debugLine="lista.RemoveAt(Pos)";
_lista.RemoveAt(_pos);
 //BA.debugLineNum = 234;BA.debugLine="TextWriter1.Initialize(File.OpenOutput(caminho,Logado&\"transacoes.txt\",True))";
...
anywheresoftware.b4a.phone.Phone _ph = null;
 //BA.debugLineNum = 368;BA.debugLine="Private Sub RenameFile(OriginalFileName As String, NewFileName As String) As Boolean";
 //BA.debugLineNum = 369;BA.debugLine="Dim Result As Int";
_result = 0;
 //BA.debugLineNum = 370;BA.debugLine="Dim StdOut, StdErr As StringBuilder";
...
_stderr = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 371;BA.debugLine="StdOut.Initialize";
_stdout.Initialize();
 //BA.debugLineNum = 372;BA.debugLine="StdErr.Initialize";
_stderr.Initialize();
 //BA.debugLineNum = 373;BA.debugLine="Dim Ph As Phone";
_ph = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 374;BA.debugLine="Result = Ph.Shell(\"mv \" & OriginalFileName & \" \" & NewFileName, Null,  StdOut, StdErr)";
_result = _ph.Shell("mv "+_originalfilename+" "+_newfilename,(String[])(__c.Null),(java.lang.StringBuilder)(_stdout.getObject()),(java.lang.StringBuilder)(_stderr.getObject()));
 //BA.debugLineNum = 375;BA.debugLine="If Result = 0 Then";
if (_result==0) { 
...
_textwriter1 = new anywheresoftware.b4a.objects.streams.File.TextWriterWrapper();
 //BA.debugLineNum = 269;BA.debugLine="TextWriter1.Initialize(File.OpenOutput(caminho, Logado&\"categ.txt\", True))";
_textwriter1.Initialize((java.io.OutputStream)(__c.File.OpenOutput(_caminho,_logado()+"categ.txt",__c.True).getObject()));
...
_textwriter1 = new anywheresoftware.b4a.objects.streams.File.TextWriterWrapper();
 //BA.debugLineNum = 211;BA.debugLine="TextWriter1.Initialize(File.OpenOutput(caminho,Logado&\"transacoes.txt\",True))";
_textwriter1.Initialize((java.io.OutputStream)(__c.File.OpenOutput(_caminho,_logado()+"transacoes.txt",__c.True).getObject()));
 //BA.debugLineNum = 212;BA.debugLine="TextWriter1.WriteLine(valor1 &\";\"& Data &\";\"& Categoria)";
