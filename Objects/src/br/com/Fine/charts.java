...
public boolean IsInitialized;
public br.com.Fine.charts._graphinternal GI;
public String Title;
public String YAxis;
public String XAxis;
public float YStart;
...
public void Initialize() {
IsInitialized = true;
GI = new br.com.Fine.charts._graphinternal();
Title = "";
YAxis = "";
XAxis = "";
YStart = 0f;
...
public static String  _addbarcolor(anywheresoftware.b4a.BA _ba,br.com.Fine.charts._bardata _bd,int _color) throws Exception{
...
public static String  _addbarpoint(anywheresoftware.b4a.BA _ba,br.com.Fine.charts._bardata _bd,String _x,float[] _yarray) throws Exception{
br.com.Fine.charts._linepoint _b = null;
...
_b = new br.com.Fine.charts._linepoint();
...
public static String  _addlinecolor(anywheresoftware.b4a.BA _ba,br.com.Fine.charts._linedata _ld,int _color) throws Exception{
...
public static String  _addlinemultiplepoints(anywheresoftware.b4a.BA _ba,br.com.Fine.charts._linedata _ld,String _x,float[] _yarray,boolean _showtick) throws Exception{
br.com.Fine.charts._linepoint _p = null;
...
_p = new br.com.Fine.charts._linepoint();
...
public static String  _addlinepoint(anywheresoftware.b4a.BA _ba,br.com.Fine.charts._linedata _ld,String _x,float _y,boolean _showtick) throws Exception{
br.com.Fine.charts._linepoint _p = null;
...
public static String  _addpieitem(anywheresoftware.b4a.BA _ba,br.com.Fine.charts._piedata _pd,String _name,float _value,int _color) throws Exception{
br.com.Fine.charts._pieitem _i = null;
...
_i = new br.com.Fine.charts._pieitem();
...
public static int  _calcpointtopixel(anywheresoftware.b4a.BA _ba,float _py,br.com.Fine.charts._graph _g) throws Exception{
...
public static anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _createlegend(anywheresoftware.b4a.BA _ba,br.com.Fine.charts._piedata _pd) throws Exception{
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bmp = null;
float _textheight = 0f;
float _textwidth = 0f;
int _i = 0;
br.com.Fine.charts._pieitem _it = null;
...
_it = new br.com.Fine.charts._pieitem();
 //BA.debugLineNum = 312;BA.debugLine="it = PD.Items.Get(i)";
_it = (br.com.Fine.charts._pieitem)(_pd.Items.Get(_i));
...
public static String  _drawbarschart(anywheresoftware.b4a.BA _ba,br.com.Fine.charts._graph _g,br.com.Fine.charts._bardata _bd,int _backcolor) throws Exception{
br.com.Fine.charts._linepoint _point = null;
...
_point = new br.com.Fine.charts._linepoint();
 //BA.debugLineNum = 47;BA.debugLine="point = BD.Points.Get(1)";
_point = (br.com.Fine.charts._linepoint)(_bd.Points.Get((int) (1)));
...
_point = (br.com.Fine.charts._linepoint)(_bd.Points.Get(_i));
...
_gi = new br.com.Fine.charts._graphinternal();
...
_p = (br.com.Fine.charts._linepoint)(_points.Get((int) (1)));
...
_p = (br.com.Fine.charts._linepoint)(_points.Get(_i));
...
public static String  _drawlinechart(anywheresoftware.b4a.BA _ba,br.com.Fine.charts._graph _g,br.com.Fine.charts._linedata _ld,int _backcolor) throws Exception{
br.com.Fine.charts._linepoint _point = null;
float[] _py2 = null;
int _i = 0;
int _a = 0;
...
_point = (br.com.Fine.charts._linepoint)(_ld.Points.Get((int) (0)));
...
_point = (br.com.Fine.charts._linepoint)(_ld.Points.Get(_i));
...
public static anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _drawpie(anywheresoftware.b4a.BA _ba,br.com.Fine.charts._piedata _pd,int _backcolor,boolean _createlegendbitmap) throws Exception{
int _radius = 0;
int _total1 = 0;
int _i = 0;
br.com.Fine.charts._pieitem _it = null;
...
_startingangle = (float) (_startingangle+_calcslice(_ba,_pd.Canvas,_radius,_startingangle,(float) (_it.Value/(double)_total1),_it.Color,_gapdegrees));
 }
};
