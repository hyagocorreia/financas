...
public class remover_categoria extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "br.com.Fine", "br.com.Fine.remover_categoria");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "br.com.Fine", "br.com.Fine.remover_categoria");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "br.com.Fine.remover_categoria", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
...
if ((mostCurrent._main._pers._deletar_categoria(BA.ObjectToString(_value))).equals("True")) { 
 //BA.debugLineNum = 39;BA.debugLine="Msgbox2(\"Categoria: \" & Value & \" foi removida com sucesso!\",\"Fine\",\"Ok\",\"\",\"\",LoadBitmap(File.DirAssets,\"fineico.png\"))";
anywheresoftware.b4a.keywords.Common.Msgbox2("Categoria: "+BA.ObjectToString(_value)+" foi removida com sucesso!","Fine","Ok","","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"fineico.png").getObject()),mostCurrent.activityBA);
...
mostCurrent._listview_categorias.RemoveAt(_position);
 ...
 //BA.debugLineNum = 42;BA.debugLine="Msgbox2(\"Categorias predefinidas não podem ser deletadas: \" & Value,\"Fine\",\"Ok\",\"\",\"\",LoadBitmap(File.DirAssets,\"fineico.png\"))";
anywheresoftware.b4a.keywords.Common.Msgbox2("Categorias predefinidas não podem ser deletadas: "+BA.ObjectToString(_value),"Fine","Ok","","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"fineico.png").getObject()),mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 44;BA.debugLine="Msgbox2(\"Existe uma Transação associada a categoria:\" & Value,\"ATENÇÃO!\",\"Ok\",\"\",\"\",LoadBitmap(File.DirAssets,\"fineico.png\"))";
anywheresoftware.b4a.keywords.Common.Msgbox2("Existe uma Transação associada a categoria:"+BA.ObjectToString(_value),"ATENÇÃO!","Ok","","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"fineico.png").getObject()),mostCurrent.activityBA);
 };
 };
