...
public Financas.Pessoais.debitos _debitos = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"Button_Financeiro",mostCurrent._button_financeiro,"Button_sair",mostCurrent._button_sair,"Button_Utilitarios",mostCurrent._button_utilitarios,"Cadastro",Debug.moduleToString(Financas.Pessoais.cadastro.class),"Calculadora",Debug.moduleToString(Financas.Pessoais.calculadora.class),"Creditos",Debug.moduleToString(Financas.Pessoais.creditos.class),"Debito",Debug.moduleToString(Financas.Pessoais.debito.class),"Debitos",Debug.moduleToString(Financas.Pessoais.debitos.class),"Extrato",Debug.moduleToString(Financas.Pessoais.extrato.class),"Financeiro",Debug.moduleToString(Financas.Pessoais.financeiro.class),"ImageView_Foto",mostCurrent._imageview_foto,"Main",Debug.moduleToString(Financas.Pessoais.main.class),"Total",Debug.moduleToString(Financas.Pessoais.total.class),"Utilitários",Debug.moduleToString(Financas.Pessoais.utilitários.class)};
}
...
public static String  _activity_create(boolean _firsttime) throws Exception{
		Debug.PushSubsStack("Activity_Create (menu) ","menu",9,mostCurrent.activityBA,mostCurrent);
try {
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
		Debug.PushSubsStack("Activity_Pause (menu) ","menu",9,mostCurrent.activityBA,mostCurrent);
try {
...
public static String  _activity_resume() throws Exception{
		Debug.PushSubsStack("Activity_Resume (menu) ","menu",9,mostCurrent.activityBA,mostCurrent);
try {
...
public static String  _button_financeiro_click() throws Exception{
		Debug.PushSubsStack("Button_Financeiro_Click (menu) ","menu",9,mostCurrent.activityBA,mostCurrent);
try {
...
public static String  _button_sair_click() throws Exception{
		Debug.PushSubsStack("Button_sair_Click (menu) ","menu",9,mostCurrent.activityBA,mostCurrent);
try {
 BA.debugLineNum = 39;BA.debugLine="Sub Button_sair_Click";
Debug.ShouldStop(64);
...
public static String  _button_utilitarios_click() throws Exception{
		Debug.PushSubsStack("Button_Utilitarios_Click (menu) ","menu",9,mostCurrent.activityBA,mostCurrent);
try {
 BA.debugLineNum = 43;BA.debugLine="Sub Button_Utilitarios_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 44;BA.debugLine="StartActivity(\"Utilitários\")";
...
mostCurrent._button_utilitarios = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Dim ImageView_Foto As ImageView";
