...
public Financas.Pessoais.debitos _debitos = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"Button_Creditos",mostCurrent._button_creditos,"Button_Debitos",mostCurrent._button_debitos,"Button_Extrato",mostCurrent._button_extrato,"Button_total",mostCurrent._button_total,"Button_Voltar",mostCurrent._button_voltar,"Cadastro",Debug.moduleToString(Financas.Pessoais.cadastro.class),"Calculadora",Debug.moduleToString(Financas.Pessoais.calculadora.class),"Creditos",Debug.moduleToString(Financas.Pessoais.creditos.class),"Debito",Debug.moduleToString(Financas.Pessoais.debito.class),"Debitos",Debug.moduleToString(Financas.Pessoais.debitos.class),"Excluir",Debug.moduleToString(Financas.Pessoais.excluir.class),"Extrato",Debug.moduleToString(Financas.Pessoais.extrato.class),"list_Extrato",_list_extrato,"Main",Debug.moduleToString(Financas.Pessoais.main.class),"Menu",Debug.moduleToString(Financas.Pessoais.menu.class),"saldo",_saldo,"Total",Debug.moduleToString(Financas.Pessoais.total.class),"Utilitários",Debug.moduleToString(Financas.Pessoais.utilitários.class)};
}
...
Debug.ShouldStop(262144);
 BA.debugLineNum = 20;BA.debugLine="Activity.LoadLayout(\"Layout_Financeiro\")";
Debug.ShouldStop(524288);
mostCurrent._activity.LoadLayout("Layout_Financeiro",mostCurrent.activityBA);
 BA.debugLineNum = 21;BA.debugLine="If list_Extrato.IsInitialized = False Then";
Debug.ShouldStop(1048576);
if (_list_extrato.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 BA.debugLineNum = 22;BA.debugLine="list_Extrato.Initialize()";
...
try {
 BA.debugLineNum = 34;BA.debugLine="Sub Button_Creditos_Click";
Debug.ShouldStop(2);
 BA.debugLineNum = 35;BA.debugLine="StartActivity(\"Creditos\")";
Debug.ShouldStop(4);
...
try {
 BA.debugLineNum = 38;BA.debugLine="Sub Button_Debitos_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 39;BA.debugLine="StartActivity(\"Debito\")";
Debug.ShouldStop(64);
...
try {
 BA.debugLineNum = 51;BA.debugLine="Sub Button_Extrato_Click";
Debug.ShouldStop(262144);
 BA.debugLineNum = 52;BA.debugLine="StartActivity(\"Extrato\")";
Debug.ShouldStop(524288);
...
try {
 BA.debugLineNum = 46;BA.debugLine="Sub Button_total_Click";
Debug.ShouldStop(8192);
 BA.debugLineNum = 47;BA.debugLine="StartActivity(\"Total\")";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 12;BA.debugLine="Dim Button_Creditos As Button";
mostCurrent._button_creditos = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 13;BA.debugLine="Dim Button_Debitos As Button";
...
mostCurrent._button_voltar = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Dim Button_total As Button";
mostCurrent._button_total = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Dim Button_Extrato As Button";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 7;BA.debugLine="Dim saldo As Float";
_saldo = 0f;
 //BA.debugLineNum = 8;BA.debugLine="Dim list_Extrato As List";
