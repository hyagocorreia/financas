...
public static String  _activity_create(boolean _firsttime) throws Exception{
		Debug.PushSubsStack("Activity_Create (debitos) ","debitos",10,mostCurrent.activityBA,mostCurrent);
try {
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
		Debug.PushSubsStack("Activity_Pause (debitos) ","debitos",10,mostCurrent.activityBA,mostCurrent);
try {
...
public static String  _activity_resume() throws Exception{
		Debug.PushSubsStack("Activity_Resume (debitos) ","debitos",10,mostCurrent.activityBA,mostCurrent);
try {
...
public static String  _button_creditar_click() throws Exception{
		Debug.PushSubsStack("Button_Creditar_Click (debitos) ","debitos",10,mostCurrent.activityBA,mostCurrent);
try {
...
public static String  _button_voltar_click() throws Exception{
		Debug.PushSubsStack("Button_Voltar_Click (debitos) ","debitos",10,mostCurrent.activityBA,mostCurrent);
try {
