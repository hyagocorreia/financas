...
_b = new Financas.Pessoais.charts._linepoint();
...
_p = new Financas.Pessoais.charts._linepoint();
...
_i = new Financas.Pessoais.charts._pieitem();
...
_it = new Financas.Pessoais.charts._pieitem();
 //BA.debugLineNum = 312;BA.debugLine="it = PD.Items.Get(i)";
_it = (Financas.Pessoais.charts._pieitem)(_pd.Items.Get(_i));
...
_point = new Financas.Pessoais.charts._linepoint();
 //BA.debugLineNum = 47;BA.debugLine="point = BD.Points.Get(1)";
_point = (Financas.Pessoais.charts._linepoint)(_bd.Points.Get((int) (1)));
...
_point = (Financas.Pessoais.charts._linepoint)(_bd.Points.Get(_i));
...
_gi = new Financas.Pessoais.charts._graphinternal();
...
_p = (Financas.Pessoais.charts._linepoint)(_points.Get((int) (1)));
...
_p = (Financas.Pessoais.charts._linepoint)(_points.Get(_i));
...
_point = (Financas.Pessoais.charts._linepoint)(_ld.Points.Get((int) (0)));
...
_point = (Financas.Pessoais.charts._linepoint)(_ld.Points.Get(_i));
