...
public class total extends Activity implements B4AActivity{
	public static total mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "Financas.Pessoais", "Financas.Pessoais.total");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (total).");
				p.finish();
			}
		}
		if (!includeTitle) {
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "Financas.Pessoais", "Financas.Pessoais.total");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "Financas.Pessoais.total", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (total) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (total) Resume **");
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (total) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public anywheresoftware.b4a.objects.LabelWrapper _label_total = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
		Debug.PushSubsStack("Activity_Create (total) ","total",6,mostCurrent.activityBA,mostCurrent);
try {
...
mostCurrent._activity.LoadLayout("Layout_Saldo",mostCurrent.activityBA);
 BA.debugLineNum = 17;BA.debugLine="Label_Total.Text = Label_Total.Text &\" \"& NumberFormat2(Main.Pers.Saldo,1,2,2,True)";
Debug.ShouldStop(65536);
mostCurrent._label_total.setText((Object)(mostCurrent._label_total.getText()+" "+anywheresoftware.b4a.keywords.Common.NumberFormat2(mostCurrent._main._pers._saldo,(int) (1),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.True)));
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
		Debug.PushSubsStack("Activity_Pause (total) ","total",6,mostCurrent.activityBA,mostCurrent);
try {
...
public static String  _activity_resume() throws Exception{
		Debug.PushSubsStack("Activity_Resume (total) ","total",6,mostCurrent.activityBA,mostCurrent);
try {
...
public static String  _button_voltar_click() throws Exception{
		Debug.PushSubsStack("Button_Voltar_Click (total) ","total",6,mostCurrent.activityBA,mostCurrent);
try {
