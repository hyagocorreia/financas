...
public static String  _button_add_click() throws Exception{
		Debug.PushSubsStack("Button_add_Click (debito) ","debito",5,mostCurrent.activityBA,mostCurrent);
try {
...
Debug.ShouldStop(16777216);
mostCurrent._main._pers._salvar_transacao((float)(Double.parseDouble(anywheresoftware.b4a.keywords.Common.NumberFormat(_valor_final,(int) (1),(int) (2)))),mostCurrent._data.getText(),mostCurrent._categoria.getSelectedItem(),"Débito");
...
if (_result==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 BA.debugLineNum = 62;BA.debugLine="StartActivity(\"Debito\")";
