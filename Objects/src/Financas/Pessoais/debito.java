...
public Financas.Pessoais.debitos _debitos = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"Button_Debitar",mostCurrent._button_debitar,"Button_Voltar",mostCurrent._button_voltar,"Cadastro",Debug.moduleToString(Financas.Pessoais.cadastro.class),"Calculadora",Debug.moduleToString(Financas.Pessoais.calculadora.class),"Creditos",Debug.moduleToString(Financas.Pessoais.creditos.class),"Data",mostCurrent._data,"Debitos",Debug.moduleToString(Financas.Pessoais.debitos.class),"Extrato",Debug.moduleToString(Financas.Pessoais.extrato.class),"Financeiro",Debug.moduleToString(Financas.Pessoais.financeiro.class),"Main",Debug.moduleToString(Financas.Pessoais.main.class),"Menu",Debug.moduleToString(Financas.Pessoais.menu.class),"Para",mostCurrent._para,"Referente",mostCurrent._referente,"Total",Debug.moduleToString(Financas.Pessoais.total.class),"Utilitários",Debug.moduleToString(Financas.Pessoais.utilitários.class),"Valor",mostCurrent._valor};
}
...
anywheresoftware.b4a.keywords.Common.Msgbox("Campos Obrigatórios não Preenchidos","Atenção!",mostCurrent.activityBA);
 ...
 BA.debugLineNum = 49;BA.debugLine="Msgbox(\"Valor:\" &Valor.Text & CRLF & \"Observação:\" & CRLF&Referente.Text & CRLF & \"Data:\" &Data.Text,\"Debitado com Sucesso\")";
...
mostCurrent._financeiro._saldo = (float) (mostCurrent._financeiro._saldo-_xvalor);
 BA.debugLineNum = 53;BA.debugLine="Dim linha_extrato As String = Data.Text & \" \" & \"(-)\" & xValor & \"    \" & limita_campo(Referente.Text, 9)";
