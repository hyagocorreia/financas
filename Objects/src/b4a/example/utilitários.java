...
public class utilitários extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.utilitários");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.utilitários");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.utilitários", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density);
...
public b4a.example.debitos _debitos = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",mostCurrent._activity,"Button_Calculadora",mostCurrent._button_calculadora,"Button_Excluir",mostCurrent._button_excluir,"Button_Graficos",mostCurrent._button_graficos,"Button_Voltar",mostCurrent._button_voltar,"Cadastro",Debug.moduleToString(b4a.example.cadastro.class),"Calculadora",Debug.moduleToString(b4a.example.calculadora.class),"Creditos",Debug.moduleToString(b4a.example.creditos.class),"Debito",Debug.moduleToString(b4a.example.debito.class),"Debitos",Debug.moduleToString(b4a.example.debitos.class),"Extrato",Debug.moduleToString(b4a.example.extrato.class),"Financeiro",Debug.moduleToString(b4a.example.financeiro.class),"Main",Debug.moduleToString(b4a.example.main.class),"Total",Debug.moduleToString(b4a.example.total.class)};
}
